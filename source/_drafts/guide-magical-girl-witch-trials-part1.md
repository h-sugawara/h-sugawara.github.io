...
thumbnail: /images/thumbnails/magical_girl_witch_trials_thumbnail.webp
cover:
...
2025年7月に Steam で発売され、2026年春に Switch 版の発売を予定している「魔法少女ノ魔女裁判」の詳細攻略ガイド前編を掲載します。
...
裁判パート以外の選択肢は、髑髏アイコンが表示されている方を選ぶとバッドエンドとなり、ストーリーの進行にはそうでない方を選ばなければならない。ただし、最終話で最初に出現する選択肢のバッドエンドには専用ＣＧがあり、ギャラリー埋めのために選択の必要があることを留意しておこう。
...
各話ごとに見出しを `#議論番号-発言番号：発言者「発言内容」` 形式で記載。発言内容は、句読点・疑問符・感嘆符・改行・沈黙表現（３点リーダ２つ）のいずれかまでを抜粋。
...
攻略ガイド後編は2025年11月下旬、レビューは2026年05月上旬にそれぞれ投稿予定です。
