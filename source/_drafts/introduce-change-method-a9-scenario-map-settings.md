...
{% gallery introduce-change-method-a9-scenario-map-settings prepare_step2_2.webp 'テンプレートを読み込む' 719x404 %}{% endgallery %}
...
{% gallery introduce-change-method-a9-scenario-map-settings temp_step1_1.webp 'ニューゲームの開始' 719x404 %}{% endgallery %}
...
{% gallery introduce-change-method-a9-scenario-map-settings temp_step2_1a.webp 'ダイヤウィザードを開始する' 719x404 %}{% endgallery %}

すると、ダイアログボックスが表示されるので、「はい」を選択します。

{% gallery introduce-change-method-a9-scenario-map-settings temp_step2_1b.webp 'ダイヤウィザードを開始する（ダイアログボックス）' 719x404 %}{% endgallery %}
...
{% gallery introduce-change-method-a9-scenario-map-settings temp_step2_4a.webp 'ダイヤウィザードを終了する' 719x404 %}{% endgallery %}

開始時と同じく、ダイアログボックスが表示されますが、今回は「**いいえ**」を選択します。

{% gallery introduce-change-method-a9-scenario-map-settings temp_step2_4b.webp 'ダイヤウィザードを終了する（ダイアログボックス）' 719x404 %}{% endgallery %}
...
{% gallery introduce-change-method-a9-scenario-map-settings change_step2_1.webp 'ダイヤウィザードを開始する' 719x404 %}{% endgallery %}
...
{% gallery introduce-change-method-a9-scenario-map-settings change_step2_4.webp 'ダイヤウィザードを終了する' 719x404 %}{% endgallery %}
