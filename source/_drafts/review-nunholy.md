...
{% gallery review-nunholy playable_sain.webp '浄化者「セイン」' 719x404 %}
ハイブリッド攻撃型のセイン
{% endgallery %}
...
メイン武器・サブ兵装・スキル・究極技を駆使して、ダンジョン内のヴァンパイアを全て退治することが基本のルールとなる。

#### ゲーム進行の仕様

ダンジョン内は扉によってフロアが仕切られている。プレイヤーは、そのフロアを一つずつ突破し、ボスヴァンパイアがいるフロアまで辿り着き、それを討伐して拠点に帰るまでが一連の流れとなる。次のフロアへ進むためには、基本ルールに則り、フロア内のヴァンパイアを全て退治しなければならない。ただし、サポートキャラクターがいるフロアの場合は、その必要はない。
...
鮮血の場合、吸収か破壊かを任意に選べる。吸収であればヴァンパイアレベル上昇とパッシブスキル獲得、破壊であれば血石の獲得になる。血石は、アーティファクトの封印解除に使え、その後にアーティファクトを入手できる。なお、アーティファクトの売買にも血石を使用する。アーティファクト強化の場合は、いずれか一つだけに効果を追加できる。

{% gallery review-nunholy vampire_level_up.webp 'ヴァンパイアレベルアップ' 719x404 %}
レベルアップ時の画面が、本作の中で最も色気があると思う
{% endgallery %}

血の聖杯は、最大体力増加効果があり、月明りのパワーは、究極技習得または能力レベルアップができるが、ダンジョン内での一時的な効果になる。一方で、ルビーや銀貨は、ダンジョン内のサポートキャラクターの好感度上げに使えるだけでなく、拠点に持って帰ることができ、武器・スキルの強化やステータス強化にも使える。
...
初期状態の操作可能なキャラクターは弱いため、強化に必要な銀貨とルビーを、一度の攻略で大量に獲得したいところである。そのため、継戦能力をなるべく維持するにあたって、ネメラ、セラフ、リリアンヌ、エヴァーレーンの順に好感度を高めていくことをオススメしたい。
...
自動受注型で、クエストを達成する度に、それぞれに設定されていたポイントが貰える。このポイントを一定数稼ぐごとに、ハンターランクが一つ上昇する。ハンターランクは、「F」から始まり、最大で「S」までの７段階。拠点で行える武器・スキル強化やステータス強化の項目をアンロックしたり、ダンジョンの入口で補給物資を多めにもらえたりするため、少なくとも「A」を目標に上げておきたいところ。
...
銀貨を消費して、訓練と強化（メイン武器・サブ兵装・スキル）を行える。強化は、定数増加に加え、ある程度のレベルから効果が付与されるので魅力的だが、レベル上昇ごとにコストも倍々で増える。一方、訓練は、倍率増加で微々たる感じだが、レベル上昇ごとに増加するコストも軽微で済む。
銀貨は入手しにくい仕様になっているので、強化を初期装備のメイン武器・サブ兵装・スキルのみに絞り、訓練になるべく割り当てていくと、効率的に運用できるだろう。振り分けに失敗したと感じたら、初期化でリセットすれば、銀貨は全て返ってくる。
...
ルビーを消費して、ヴァンバイアとしての各種ステータスを強化できる。攻撃力上昇の「筋力向上」、防御力上昇の「硬い肌」、最大体力増加の「強化された肉体」は、確実に上昇させる手段がないため、優先してレベルアップを目指したいところ。他にも、交戦完了後の体力回復「肉体ダメージの修復」、ボス撃破後の体力回復「生命力奪取」は、継戦能力向上にも寄与して、ヴァンパイアレベルを上げないで挑む時にも生きるので、次点で着手したい能力になる。なお、こちらについても初期化でリセットすれば、ルビーは全て返ってくる仕様である。
...
武器使用時に、キーボードだけではなくマウスカーソルも操作が必要なため、操作性はとても悪い。そういった癖が強い操作が要求されるにも関わらず、その説明が一切されていなかったため、プレイし始めた頃に、全く操作が出来ずに困惑したことが、大きな減点要因。
...
ローグライクが好きであれば嵌る。そこまで好きでもない場合は、プレイヤーに対して何かしらの報酬が与えられるわけではないので、ダンジョンを何度も周回することに苦痛を感じるかもしれない。

#### 音楽

意外と激しい BGM が多め。アクションゲームなので、そういう曲調の方がノれるので良い。
