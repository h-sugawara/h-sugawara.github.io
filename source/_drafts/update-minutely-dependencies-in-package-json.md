---
title: package.jsonの依存関係の更新を緻密に管理する方法
...
package.json に追加した依存関係のバージョン更新を緻密に管理できる、痒い所に手が届く便利な npm パッケージをご紹介します。
...
package.json の依存関係に追加したパッケージや、npm のグローバルインストールしたパッケージを、任意のバージョンで緻密に管理したい人。
