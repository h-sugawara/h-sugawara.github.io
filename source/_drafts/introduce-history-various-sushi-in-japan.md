...
{% gallery introduce-history-various-sushi-in-japan nigiri_zushi.webp '握り寿司' 719x404 %}{% endgallery %}
...
{% gallery introduce-history-various-sushi-in-japan gomoku_chirashi.webp '五目ちらし' 719x404 %}{% endgallery %}

##### 江戸前ちらし

江戸前ちらしは、にぎり寿司から派生した寿司で、「生ちらし」「吹き寄せちらし」とも呼ばれます。

{% gallery introduce-history-various-sushi-in-japan edomae_chirashi.webp '江戸前ちらし' 719x404 %}{% endgallery %}
