...
バランス型、または、ダンス特化型を中心に選ぼう。他の特化型であれば、{% ruby 黒金|くろがね 蓮|れん %}、{% ruby 琴森|こともり 愛莉|あいり %}、{% ruby 陽本|ひのもと 日夏|ひなつ %}の３名がオススメ。なお、センター適性の仕様上、一期生でボーカル特化型は選ばない方が良い。
...
５か月前後で、経営力と発信力を E、企画力を D、グッズ開発を Lv.2 にする。1400万前後の資金が必要。営業力を優先して上げると、資金調達が最大効果になる。
