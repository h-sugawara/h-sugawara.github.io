...
攻略を調べに来たのであれば、{% post_link guide-riddle-joker '別記事に掲載しています' %}ので、そちらを是非ご覧ください。
{% endmessage %}
...
- ストーリープレイ画面
  - SAVE、LOAD、Q.SAVE、Q.LOAD、SYSTEM、前・次のシーンへ移動、前・次の選択肢へ移動、バックログ、オート、スキップ・バックスキップ、ウインドウ非表示、お気に入りボイス登録、フローチャート表示
- エクストラモード
  - CG鑑賞、BGM鑑賞、シーン鑑賞、ムービー鑑賞、立ち絵鑑賞、お気に入りボイス
- アフターストーリー
  - 全ヒロインあり
- システム設定
  - 画面表示（簡易・詳細）、ゲーム進行、テキスト、サウンド、ダイアログ、マウス、ショートカットキー、ゲームパッド
