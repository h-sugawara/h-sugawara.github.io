...
市場全体に対して同一製品を同一のマーケティングで販売できれば、企業は効率的に収益を上げられる。一方で、顧客満足度を最大化したければ、顧客一人ひとりに専用品を提供することが望ましい。
...
セグメントは、単に細かく分ければ良いというものではなく、十分な売上高や利益を確保できる規模があることや、重要度に応じて優先順位を付けられるなどの条件を満たす必要がある。また、顧客層にアプローチし、顧客の反応を測定・分析できるか等の実現可能性にも考慮しなくてはならない。
