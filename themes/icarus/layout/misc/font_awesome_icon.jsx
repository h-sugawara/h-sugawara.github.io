...
module.exports = class extends Component {
    renderListUl(className) {
        return <svg class={className} xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512">
    ...
    renderChevronLeft(className) {
        return <svg class={className} xmlns="http://www.w3.org/2000/svg" height="16" width="10" viewBox="0 0 320 512">
    ...
    renderCreativeCommons(className) {
        return <svg class={className} xmlns="http://www.w3.org/2000/svg" height="16" width="15.5" viewBox="0 0 496 512">
